...
class TankGame():
    ...
    def Gaming(self):
        #绘制地图
        for eachBrick in  self.map.brickGroup:
            self.screen.blit(eachBrick.image,eachBrick.rect)

        for eachIron in  self.map.ironGroup:
            self.screen.blit(eachIron.image,eachIron.rect)
